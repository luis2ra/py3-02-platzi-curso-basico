# class 15: Varios países en mi conversor de monedas
...
# de derecha a izquierda: llamo a la funcion input, le paso la variable menu 
# para que la imprima y reciba el número que el usuario escogió, lo convierto 
# a int y lo guardo en la variable 'opcion'
